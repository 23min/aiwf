...
// for one — it relaxes the FSM transition rule, and a force trailer
// from a non-human actor is itself refused at the apply seam, so both
// routes into these transitions require a human (ADR-0040). Exported so
