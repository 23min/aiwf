...
//
// entity itself doesn't invoke git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function is pure FSM / parser /
// allocator exercise over in-memory data; no filesystem, no env,
// no subprocess.
