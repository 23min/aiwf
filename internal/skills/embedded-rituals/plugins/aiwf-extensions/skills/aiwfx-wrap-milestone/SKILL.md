...
- `## Release note` — confirm it still describes what a consumer will observe after any corrective commits from step 2. It is empty only when nothing user-visible changed, and says so in those words.
