...
func TestList_AllShippedSkillsPresent(t *testing.T) {
	...
	want := []string{"aiwf-acknowledge", "aiwf-add", "aiwf-archive", "aiwf-authorize", "aiwf-check", "aiwf-contract", "aiwf-edit-body", "aiwf-history", "aiwf-list", "aiwf-promote", "aiwf-reallocate", "aiwf-rename", "aiwf-render", "aiwf-retitle", "aiwf-show", "aiwf-status"}
	if len(got) != len(want) {
