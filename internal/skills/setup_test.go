...
//
// skills itself doesn't invoke git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function is read-only against the
// embedded skill bundle or uses t.TempDir for materialize fixtures.
