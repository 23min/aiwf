...
//
// This package doesn't shell out to git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function in this package reasons
// over pure inputs (env maps, yaml bytes) or writes to an in-memory
// buffer — no shared state or env mutation via os.Setenv.
