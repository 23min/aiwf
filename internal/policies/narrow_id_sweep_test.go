...
func TestPolicy_NarrowIDLiteralsAllowlisted(t *testing.T) {
	...
	allowlist := map[string]string{
		...
		"internal/policies/guidance_fence_test.go":                 "M-0333 AC-2 width-tolerance row: a guidance commit trailer naming a narrow id (M-312) must resolve to the same entity as its canonical width",
