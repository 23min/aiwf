...
//
// htmlrender itself doesn't invoke git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function uses t.TempDir (directly
// or via writeFixtureTree) for filesystem isolation.
