...
//
// check itself doesn't invoke git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function uses t.TempDir or
// in-memory tree fixtures; no shared package-level state.
