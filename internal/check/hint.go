...
var hintTable = map[string]string{
	...
	"priority-valid":                    "run `aiwf set-priority <id> <level>` with a level from the closed set (urgent, high, medium, low), or clear the field by hand and re-run `aiwf check`",
