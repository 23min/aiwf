...
// M-0253/AC-1 backfill: retitle.Run's ResolveRoot and tree.Load
// fatal-IO branches are `//coverage:ignore`d in retitle.go itself,
...
func TestRun_ResolveActorFailure(t *testing.T) {
	...
	rc := retitle.Run("E-0001", "New Title", "", "", root, "", out)
