...
// history_diag_test.go — M-0249 follow-up: pins Run's own diagnostic-
...
func TestRunDiag_FallsBackWhenCorrelationIDEmpty(t *testing.T) {
	...
	_ = history.Run("G-0001", root, "text", false, false, "")
...
// TestRunDiag_ActorResolutionFailureStillEmitsEvent pins history's
// own best-effort actor rationale (no --actor flag, mirroring
