...
// the guard for `aiwf history`'s BuildScopeEntityMap grep. When it returns
// false, RenderScopeChips never reads the map — an authorize opener's own
