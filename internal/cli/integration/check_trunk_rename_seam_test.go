...
func TestBinary_Check_TrunkRenameNotCollision(t *testing.T) {
	...
	testutil.MustExec(t, repo, "git", "checkout", "-q", "-b", "fix/slug-cleanup")
	newRel := "work/gaps/G-0035-short.md"
	testutil.MustExec(t, repo, "git", "mv", oldRel, newRel)
	testutil.MustExec(t, repo, "git", "commit", "-q", "-m", "rename G-0035 slug")
...
func TestBinary_Check_NonRenameSameIDStillCollides(t *testing.T) {
	...
	testutil.MustExec(t, repo, "git", "add", "aiwf.yaml", oldRel)
	testutil.MustExec(t, repo, "git", "commit", "-q", "-m", "seed: trunk gap")
	testutil.MustExec(t, repo, "git", "branch", "trunk")
	...
	testutil.MustExec(t, repo, "git", "checkout", "-q", "-b", "feature/parallel-collision")
	testutil.MustExec(t, repo, "git", "rm", "-q", oldRel)
	...
	testutil.MustExec(t, repo, "git", "add", newRel)
	testutil.MustExec(t, repo, "git", "commit", "-q", "-m", "feature: different G-0050")
