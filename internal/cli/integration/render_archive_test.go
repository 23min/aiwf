...
func TestRender_PerEntityPageRendersForArchivedEntity(t *testing.T) {
	...
	body := testutil.ReadFileT(t, archivedPagePath)
...
func TestRender_PerEntityPageMarksArchivedState(t *testing.T) {
	...
	archivedBody := testutil.ReadFileT(t, filepath.Join(out, "G-0099.html"))
	...
	activeBody := testutil.ReadFileT(t, filepath.Join(out, "G-0001.html"))
