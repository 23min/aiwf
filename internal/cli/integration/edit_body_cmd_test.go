...
func TestEditBody_BinaryEndToEnd(t *testing.T) {
	...
	if out, err := testutil.RunBin(t, root, binDir, nil, "add", "epic", "--title", "Foundations"); err != nil {
	...
	out, err := testutil.RunBin(t, root, binDir, nil, "edit-body", "E-0001", "--body-file", bodyPath)
	if err != nil {
...
func TestEditBody_RejectsFrontmatter_BinaryEndToEnd(t *testing.T) {
	...
	if out, err := testutil.RunBin(t, root, binDir, nil, "add", "epic", "--title", "Edit target"); err != nil {
		t.Fatalf("add epic: %v\n%s", err, out)
	}
...
func TestEditBody_Bless_BinaryEndToEnd(t *testing.T) {
	...
	if out, err := testutil.RunBin(t, root, binDir, nil, "add", "epic", "--title", "Bless target"); err != nil {
		t.Fatalf("add epic: %v\n%s", err, out)
	}
	...
	out, err := testutil.RunBin(t, root, binDir, nil, "edit-body", "E-0001")
	if err != nil {
...
func TestEditBody_Bless_NoChanges_BinaryRefusal(t *testing.T) {
	...
	out, err := testutil.RunBin(t, root, binDir, nil, "edit-body", "G-0001")
	if err == nil {
