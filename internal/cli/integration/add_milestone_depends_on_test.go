...
func addMilestoneDependsOnSetup(t *testing.T) string {
	...
	if rc := cli.Execute([]string{"add", "milestone", "--epic", "E-0001", "--tdd", "none", "--title", "Second", "--actor", "human/test", "--root", root}); rc != cliutil.ExitOK {
...
func TestAddMilestone_DependsOnAbsent(t *testing.T) {
	...
	if rc := cli.Execute([]string{"add", "milestone", "--epic", "E-0001", "--tdd", "none", "--title", "Solo", "--actor", "human/test", "--root", root}); rc != cliutil.ExitOK {
