...
//
// aiwfyaml itself doesn't invoke git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function is pure-parser over
// in-memory bytes or uses t.TempDir for the one atomic-write test.
