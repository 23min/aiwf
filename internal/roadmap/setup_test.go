...
//
// roadmap itself doesn't invoke git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function is either pure-function
// over in-memory trees or uses t.TempDir for filesystem isolation.
