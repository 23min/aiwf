...
func TestSchema_EnumeratesEveryYAMLField(t *testing.T) {
	...
	want := []SchemaField{
		...
		{Path: "docs", Type: "config.Docs"},
		{Path: "docs.paths", Type: "[]string"},
		{Path: "docs.strict", Type: "bool"},
		...
		{Path: "guidance.enabled", Type: "*bool"},
		{Path: "guidance.source", Type: "string"},
		{Path: "guidance.packs", Type: "*[]string"},
		{Path: "guidance.ignored", Type: "[]string"},
		...
		{Path: "logging", Type: "config.Logging"},
		{Path: "logging.level", Type: "string"},
		{Path: "logging.format", Type: "string"},
		{Path: "logging.destination", Type: "string"},
