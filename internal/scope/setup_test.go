...
//
// scope itself doesn't shell out to git, but the template is uniform
// across internal/* per M-0091.
//
// Serial tests: none. Every Test* function is pure FSM exercise over
// trailer-set fixtures; no filesystem or env mutation.
