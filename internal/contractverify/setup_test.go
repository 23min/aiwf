...
//
// contractverify itself doesn't invoke git, but the template is
// uniform across internal/* per M-0091.
//
// Serial tests: none. Every Test* function uses t.TempDir for
// filesystem isolation; fake validator scripts live inside the
// per-test tempdir.
