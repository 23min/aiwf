...
## E-20 — Add list verb (closes G-061) (done)
...
| Milestone | Title | Status |
|---|---|---|
| M-072 | aiwf list verb, status filter-helper refactor, contract-skill drift fix | done |
...
| M-080 | Whiteboard skill fixture validation; retire critical-path.md; close E-21 | done |
