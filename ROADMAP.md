...
## E-0071 — Milestone tdd-policy mutation verb (G-0168) (done)
...
| Milestone | Title | Status |
|---|---|---|
| M-0287 | Detect real ids in code spans and below-width placeholders in shipped surfaces | done |
| M-0288 | Sweep shipped surfaces to canonical placeholders and enforce at error severity | done |
...
## E-0079 — Enforce sovereign force where the kernel claims to enforce it (done)
...
| M-0320 | Re-key the coverage drivers and reconcile the rejection-layer axis | in_progress |
