...
| R-AUDIT-0109 | cmd/aiwf/verbs_cmd.go | add ac --tests | `aiwf add ac --tests "..."` | `aiwf add ac` does not accept `--tests`; red-phase metrics are recorded at the red promote (`aiwf promote --phase red --tests`), not at add time | hard-reject (unknown flag) |
