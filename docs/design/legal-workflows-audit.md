...
| R-AUDIT-0121 | internal/cli/rewidth/rewidth.go | rewidth verb | `aiwf rewidth --apply` | Migrates narrow-legacy entity ids to canonical 4-digit width (ADR-0008); idempotent; one commit | hard-reject |
