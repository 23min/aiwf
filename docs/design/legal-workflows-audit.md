...
| R-AUDIT-0120 | internal/cli/retitle/retitle.go | retitle verb | `aiwf retitle <id> "<title>"` | Updates frontmatter title and re-derives on-disk slug from it in one commit (G-0108); new title subject to the title_max_length cap | hard-reject |
