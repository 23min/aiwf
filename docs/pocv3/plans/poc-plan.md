...
|---|---|---|---|
| **I3** | [`governance-html-plan.md`](governance-html-plan.md) | shipped (steps 1–7 done; see plan status table) | Static-site HTML render of canonical planning state (per-repo governance page). |
