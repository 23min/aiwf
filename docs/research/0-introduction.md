...
- **`docs/archive/architecture.md` is the starting state**, not the current position. It describes the framework as it was first imagined: ambitious, clever, structurally elaborate. The README marks it as superseded; the research arc is the record of why.
...
- Starting state (superseded): [docs/archive/architecture.md](https://github.com/23min/ai-workflow-v2/blob/main/docs/archive/architecture.md)
