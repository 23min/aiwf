...
- [`docs/explorations/policies-design-space.md`](../explorations/01-policies-design-space.md) — the source material. §3 (categories) and §9 (contracts-stretch) describe the territory; §5–§7 sketch lifecycle, provenance, and form options. The thesis confirms the should; the form-question stays in the exploration's lane.
...
- Source exploration: [`docs/explorations/policies-design-space.md`](../explorations/01-policies-design-space.md) — where the form-question converges.
