...
- **Normative** — current-truth, kept in lockstep with the code: `docs/adr/` (terminal-status ADRs move to `docs/adr/archive/` under the same forget-by-default convention as the Archival tier below), `docs/design/`, `docs/architecture.md`, `docs/overview.md`, `docs/workflows.md`, `docs/skill-author-guide.md`.
