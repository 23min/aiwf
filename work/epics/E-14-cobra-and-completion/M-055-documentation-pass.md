...
_Grandfathered: this AC was met before M-066's `entity-body-empty` rule made body prose required. The behavior pinned here is recorded in the AC's commit chain — see `aiwf history M-055/AC-1` for the actual implementation history._

### AC-2 — No 'previously was' or migration notes in any user-facing docs

_Grandfathered: this AC was met before M-066's `entity-body-empty` rule made body prose required. The behavior pinned here is recorded in the AC's commit chain — see `aiwf history M-055/AC-2` for the actual implementation history._

### AC-3 — README CLI section reflects the Cobra-shaped surface

_Grandfathered: this AC was met before M-066's `entity-body-empty` rule made body prose required. The behavior pinned here is recorded in the AC's commit chain — see `aiwf history M-055/AC-3` for the actual implementation history._

### AC-4 — CLAUDE.md Go conventions references Cobra as standard CLI library

_Grandfathered: this AC was met before M-066's `entity-body-empty` rule made body prose required. The behavior pinned here is recorded in the AC's commit chain — see `aiwf history M-055/AC-4` for the actual implementation history._
