...
- **G-0130 absorbed as M-0126; G-0129 absorbed as M-0127.** Both new milestones inserted between M-0123 (Pass C) and M-0124/M-0125 (cell coverage), so the cell tests run against the actually-enforced spec. M-0124 and M-0125 dependencies updated accordingly.
...
- **G-0130** — `fsm-history-consistent` check implementation. Absorbed as **M-0126** in E-0033 (inserted before M-0124/M-0125). Without it, R-RULE-001..018 in the catalog read as target severity rather than current. M-0124 and M-0125 depend on M-0126.
