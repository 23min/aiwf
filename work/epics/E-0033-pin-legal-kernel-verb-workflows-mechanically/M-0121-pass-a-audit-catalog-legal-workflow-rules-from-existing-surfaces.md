...
- **G-0130 absorbed as M-0130; G-0129 absorbed as M-0127.** Both new milestones inserted between M-0123 (Pass C) and M-0124/M-0125 (cell coverage), so the cell tests run against the actually-enforced spec. M-0124 and M-0125 dependencies updated accordingly.
...
- **No `t.Skip` markers in this milestone's tests.** M-0121's ACs are about the catalog file's shape, which is fully testable today. The downstream milestones M-0124/M-0125 will carry `t.Skip` markers for cells that depend on M-0130/M-0127 — those are tagged at test-write time.
