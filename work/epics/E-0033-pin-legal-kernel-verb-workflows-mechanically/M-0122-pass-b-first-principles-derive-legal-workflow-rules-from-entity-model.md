...
- **R2 sed updates bundled here.** The merge from main brought `aiwf reallocate G-0128 → G-0132`, which auto-rewrote references in entity frontmatter and bodies but not in `legal-workflows-audit.md` (not an aiwf entity). The 5 catalog substitutions were applied by sed in the parent session post-reallocate; they were uncommitted when M-0122 work began and ride along in this wrap commit.
