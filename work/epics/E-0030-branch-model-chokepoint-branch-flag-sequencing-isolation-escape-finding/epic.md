...
|---|---|---|
| Rituals plugin updates lag the kernel surface, leaving operators unable to use the new flag through standard ritual flow | Medium | Each ritual-update milestone (M-0104, M-0105) edits both the testdata fixture and the embedded snapshot in the same commit. `TestRituals_VendoredMatchesUpstream` validates against the upstream pinned ref; `make sync-rituals` is part of the milestone's deliverable when the upstream commit lands. |
...
- [ADR-0014](../../../docs/adr/ADR-0014-embed-and-materialize-rituals-distribution-retire-claude-marketplace.md) — Embed-and-materialize rituals (E-0038, done); the cross-repo edit shape M-0104/M-0105 follows
...
- `CLAUDE.md § "Cross-repo plugin testing"` — the testdata-fixture-plus-embedded-snapshot shape M-0104/M-0105 use
