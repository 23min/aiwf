...
- **G-0295** — consolidate the three ack-walker HEAD-walk loops into one `forEachCommitTrailers` primitive (rule-of-three crossed; surfaced by the pre-wrap `wf-rethink`). DRY cleanup, not a correctness fix.
