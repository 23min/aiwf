...
- **Inherited trunk-collision** (not M-0185 substance): the M-0208-era gap at its old id collided with a different gap that had since landed on trunk → resolved via `aiwf reallocate` (`G-0302` → `G-0306`).
