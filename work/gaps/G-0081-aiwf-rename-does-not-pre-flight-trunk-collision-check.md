...
- E-0021 milestone planning conversation, 2026-05-08 — surface event. Reverted via `git reset --hard` since the rename commits were local-only and not pushed.
...
- G-0072 (depends_on writer verb — closed via E-0022/M-0076), G-0065 (no `aiwf retitle` verb — closed via E-0022/M-0077) — adjacent verb-asymmetry gaps that closed during the E-0021 planning session that surfaced this one. This gap is shape-different: the rename verb exists; it just doesn't pre-flight against the trunk-collision rule.
