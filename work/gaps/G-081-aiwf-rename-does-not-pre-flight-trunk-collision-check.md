...
- G-072 (depends_on writer verb), G-065 (no `aiwf retitle` verb) — adjacent verb-asymmetry gaps. This one is shape-different: the verb exists; it just doesn't pre-flight.
