...
This gap is *not* `discovered_in` M-069. It surfaced during a conversation that broadened from the M-069 branch-model finding (G-059) to an architectural omission this repo has been carrying for longer. Treat it as the older, deeper question of which G-059 is one corner.
