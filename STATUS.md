...
- → **M-058** — Add aiwf edit-body verb and reconcile skill _(in_progress)_ — ACs 2/4 met (2 open)
...
flowchart LR
  ...
  E_15 --> M_057
  M_058["M-058 (2/4)<br/>Add aiwf edit-body verb and reconcile skill"]:::ms_in_progress
  E_15 --> M_058
...
|------|-------|------|--------|
| 2026-05-06 | human/peter | promote | aiwf promote M-058/AC-1 open -> met |
