...
- **M-0100** — Sidebar adds gap entry + epic archive chip filter _(draft)_ — tdd: required
...
flowchart LR
  ...
  E_0029 --> M_0099
  M_0100["M-0100<br/>Sidebar adds gap entry + epic archive chip filter"]:::ms_draft
  E_0029 --> M_0100
