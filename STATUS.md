...
- → **M-074** — skill-coverage policy, judgment ADR, CLAUDE.md skills section, G-061 closure _(in_progress)_ — ACs 1/11 met (10 open) — tdd: required
...
flowchart LR
  ...
  E_20 --> M_073
  M_074["M-074 (1/11)<br/>skill-coverage policy, judgment ADR, CLAUDE.md skills section, G-061 closure"]:::ms_in_progress
  E_20 --> M_074
