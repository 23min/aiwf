...
- → **M-072** — aiwf list verb, status filter-helper refactor, contract-skill drift fix _(in_progress)_ — ACs 6/9 met (3 open) — tdd: required
...
flowchart LR
  ...
  M_072["M-072 (6/9)<br/>aiwf list verb, status filter-helper refactor, contract-skill drift fix"]:::ms_in_progress
  E_20 --> M_072
...
| 2026-05-09 | human/peter | promote | aiwf promote M-072/AC-3 open -> met |
| 2026-05-09 | human/peter | promote | aiwf promote M-072/AC-3 --phase green -> done |
| 2026-05-09 | human/peter | promote | aiwf promote M-072/AC-3 --phase red -> green |
