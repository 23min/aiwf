...
- → **M-076** — Writer surface for milestone depends_on (closes G-072) _(in_progress)_ — ACs 7/7 met — tdd: required
...
flowchart LR
  ...
  E_22 --> M_075
  M_076["M-076 (7/7)<br/>Writer surface for milestone depends_on (closes G-072)"]:::ms_in_progress
  E_22 --> M_076
