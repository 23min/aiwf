...
- → **M-068** — aiwf-add skill names fill-in-body as required next step _(in_progress)_ — ACs 2/5 met (3 open) — tdd: required
...
flowchart LR
  ...
  E_17 --> M_067
  M_068["M-068 (2/5)<br/>aiwf-add skill names fill-in-body as required next step"]:::ms_in_progress
  E_17 --> M_068
