...
- → **M-060** — Bless-current-edits mode for aiwf edit-body _(in_progress)_ — ACs 3/5 met (2 open)
...
flowchart LR
  ...
  E_15 --> M_059
  M_060["M-060 (3/5)<br/>Bless-current-edits mode for aiwf edit-body"]:::ms_in_progress
  E_15 --> M_060
...
| 2026-05-06 | human/peter | promote | aiwf promote M-060/AC-1 open -> met |
