...
- → **M-068** — aiwf-add skill names fill-in-body as required next step _(in_progress)_ — ACs 5/5 met — tdd: required
...
flowchart LR
  ...
  E_17 --> M_067
  M_068["M-068 (5/5)<br/>aiwf-add skill names fill-in-body as required next step"]:::ms_in_progress
  E_17 --> M_068
...
|------|-------|------|--------|
| 2026-05-07 | human/peter | promote | aiwf promote M-068/AC-5 --phase green -> done |
| 2026-05-07 | human/peter | promote | aiwf promote M-068/AC-5 --phase red -> green |
| 2026-05-07 | human/peter | promote | aiwf promote M-068/AC-4 open -> met |
