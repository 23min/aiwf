...
- → **M-079** — aiwfx-whiteboard skill: classification rubric, output template, Q&A gate _(in_progress)_ — ACs 6/8 met (2 open) — tdd: advisory
...
flowchart LR
  ...
  E_21 --> M_078
  M_079["M-079 (6/8)<br/>aiwfx-whiteboard skill: classification rubric, output template, Q&A gate"]:::ms_in_progress
  E_21 --> M_079
