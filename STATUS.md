...
- → **M-061** — Contract family migration + changelog retrofill + help-recursion test _(in_progress)_ — ACs 5/5 met
...
flowchart LR
  ...
  E_14 --> M_055
  M_061["M-061 (5/5)<br/>Contract family migration + changelog retrofill + help-recursion test"]:::ms_in_progress
  E_14 --> M_061
