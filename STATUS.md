...
- → **M-067** — aiwf add ac --body-file flag for in-verb body scaffolding _(in_progress)_ — ACs 6/7 met (1 open) — tdd: required
...
flowchart LR
  ...
  E_17 --> M_066
  M_067["M-067 (6/7)<br/>aiwf add ac --body-file flag for in-verb body scaffolding"]:::ms_in_progress
  E_17 --> M_067
...
|------|-------|------|--------|
| 2026-05-07 | human/peter | promote | aiwf promote M-067/AC-8 --phase red -> green |
