...
_196 entities · 0 errors · 2 warnings · run `aiwf check` for details_
...
- → **M-079** — aiwfx-whiteboard skill: classification rubric, output template, Q&A gate _(in_progress)_ — ACs 2/8 met (6 open) — tdd: advisory
...
flowchart LR
  ...
  E_21 --> M_078
  M_079["M-079 (2/8)<br/>aiwfx-whiteboard skill: classification rubric, output template, Q&A gate"]:::ms_in_progress
  E_21 --> M_079
...
|------|--------|------|---------|
| acs-tdd-audit | M-079/AC-1 | work/epics/E-21-open-work-synthesis-recommended-sequence-skill-replaces-critical-path-md/M-079-aiwfx-whiteboard-skill-classification-rubric-output-template-q-a-gate.md | M-079/AC-1 status: met under tdd: advisory but tdd_phase is (absent) (expected done) |
...
|------|-------|------|--------|
| 2026-05-09 | human/peter | promote | aiwf promote M-079/AC-2 open -> met |
