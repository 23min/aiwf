...
- → **M-052** — Migrate setup verbs _(in_progress)_ — ACs 2/4 met (2 open)
...
flowchart LR
  ...
  E_14 --> M_051
  M_052["M-052 (2/4)<br/>Migrate setup verbs"]:::ms_in_progress
  E_14 --> M_052
...
|------|-------|------|--------|
| 2026-05-07 | human/peter | promote | aiwf promote M-052/AC-1 open -> met |
