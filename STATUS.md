...
- → **M-051** — Migrate mutating verbs _(in_progress)_ — ACs 5/6 met (1 open)
...
flowchart LR
  ...
  E_14 --> M_050
  M_051["M-051 (5/6)<br/>Migrate mutating verbs"]:::ms_in_progress
  E_14 --> M_051
...
|------|-------|------|--------|
| 2026-05-07 | human/peter | promote | aiwf promote M-051/AC-4 open -> met |
