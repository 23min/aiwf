...
- → **M-061** — Contract family migration + changelog retrofill + help-recursion test _(in_progress)_ — ACs 3/5 met (2 open)
...
flowchart LR
  ...
  E_14 --> M_055
  M_061["M-061 (3/5)<br/>Contract family migration + changelog retrofill + help-recursion test"]:::ms_in_progress
  E_14 --> M_061
