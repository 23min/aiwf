...
- → **M-070** — aiwf doctor warning for missing recommended plugins _(in_progress)_ — ACs 7/7 met — tdd: required
...
flowchart LR
  ...
  M_070["M-070 (7/7)<br/>aiwf doctor warning for missing recommended plugins"]:::ms_in_progress
  E_18 --> M_070
