...
- → **M-077** — aiwf retitle verb for entities and ACs (closes G-065) _(in_progress)_ — ACs 5/6 met (1 open) — tdd: required
...
flowchart LR
  ...
  E_22 --> M_076
  M_077["M-077 (5/6)<br/>aiwf retitle verb for entities and ACs (closes G-065)"]:::ms_in_progress
  E_22 --> M_077
