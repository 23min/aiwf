...
- → **M-079** — aiwfx-whiteboard skill: classification rubric, output template, Q&A gate _(in_progress)_ — ACs 3/8 met (5 open) — tdd: advisory
...
flowchart LR
  ...
  E_21 --> M_078
  M_079["M-079 (3/8)<br/>aiwfx-whiteboard skill: classification rubric, output template, Q&A gate"]:::ms_in_progress
  E_21 --> M_079
