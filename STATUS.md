...
- **M-070** — aiwf doctor warning for missing recommended plugins _(draft)_ — ACs 0/1 met (1 open) — tdd: required
...
flowchart LR
  ...
  M_070["M-070 (0/1)<br/>aiwf doctor warning for missing recommended plugins"]:::ms_draft
  E_18 --> M_070
