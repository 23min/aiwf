...
- **M-0100** — Sidebar adds gap entry + epic archive chip filter _(draft)_ — ACs 0/3 met (3 open) — tdd: required
...
flowchart LR
  ...
  E_0029 --> M_0099
  M_0100["M-0100 (0/3)<br/>Sidebar adds gap entry + epic archive chip filter"]:::ms_draft
  E_0029 --> M_0100
