...
- → **M-0087** — Display surfaces for archived entities (status, show, render) _(in_progress)_ — ACs 3/9 met (6 open) — tdd: required
...
flowchart LR
  ...
  E_0024 --> M_0086
  M_0087["M-0087 (3/9)<br/>Display surfaces for archived entities (status, show, render)"]:::ms_in_progress
  E_0024 --> M_0087
