...
- → **M-0098** — Render-site layout overhaul: viewport-fill body, flush-left sidebar, prose cap _(in_progress)_ — ACs 2/4 met (2 open) — tdd: required
...
flowchart LR
  ...
  M_0098["M-0098 (2/4)<br/>Render-site layout overhaul: viewport-fill body, flush-left sidebar, prose cap"]:::ms_in_progress
  E_0029 --> M_0098
