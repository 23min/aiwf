...
- → **M-081** — Canonical 4-digit IDs in parser, renderer, and allocator _(in_progress)_ — ACs 4/6 met (2 open) — tdd: required
...
flowchart LR
  ...
  M_081["M-081 (4/6)<br/>Canonical 4-digit IDs in parser, renderer, and allocator"]:::ms_in_progress
  E_23 --> M_081
