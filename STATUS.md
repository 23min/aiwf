...
_197 entities · 0 errors · 7 warnings · run `aiwf check` for details_
...
|------|--------|------|---------|
| acs-tdd-audit | M-079/AC-4 | work/epics/E-21-open-work-synthesis-recommended-sequence-skill-replaces-critical-path-md/M-079-aiwfx-whiteboard-skill-classification-rubric-output-template-q-a-gate.md | M-079/AC-4 status: met under tdd: advisory but tdd_phase is green (expected done) |
...
| 2026-05-09 | human/peter | promote | aiwf promote M-079/AC-3 --phase  -> red |
| 2026-05-09 | human/peter | promote | aiwf promote M-079/AC-2 --phase green -> done |
