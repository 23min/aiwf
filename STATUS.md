...
- → **M-0099** — Kind-index chip filter: single emitted file per kind with :target chips _(in_progress)_ — ACs 0/4 met (4 open) — tdd: required
...
flowchart LR
  ...
  E_0029 --> M_0098
  M_0099["M-0099 (0/4)<br/>Kind-index chip filter: single emitted file per kind with :target chips"]:::ms_in_progress
  E_0029 --> M_0099
