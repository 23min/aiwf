...
_215 entities · 0 errors · 12 warnings · run `aiwf check` for details_
...
- → **M-0087** — Display surfaces for archived entities (status, show, render) _(in_progress)_ — ACs 0/3 met (3 open) — tdd: required
...
flowchart LR
  ...
  E_0024 --> M_0086
  M_0087["M-0087 (0/3)<br/>Display surfaces for archived entities (status, show, render)"]:::ms_in_progress
  E_0024 --> M_0087
