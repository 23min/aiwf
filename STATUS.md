...
- → **M-0100** — Sidebar adds gap entry + epic archive chip filter _(in_progress)_ — ACs 1/3 met (2 open) — tdd: required
...
flowchart LR
  ...
  E_0029 --> M_0099
  M_0100["M-0100 (1/3)<br/>Sidebar adds gap entry + epic archive chip filter"]:::ms_in_progress
  E_0029 --> M_0100
