...
- → **M-0095** — Enforce human-only actor on aiwf promote E-NN active _(in_progress)_ — ACs 3/4 met (1 open) — tdd: required
...
flowchart LR
  ...
  E_0028 --> M_0094
  M_0095["M-0095 (3/4)<br/>Enforce human-only actor on aiwf promote E-NN active"]:::ms_in_progress
  E_0028 --> M_0095
...
| 2026-05-11 | human/peter | promote | aiwf promote M-0095/AC-2 open -> met |
