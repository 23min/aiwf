...
- **M-071** — Install ritual plugins in kernel repo + document operator setup path _(draft)_ — ACs 0/1 met (1 open) — tdd: required
...
flowchart LR
  ...
  E_18 --> M_070
  M_071["M-071 (0/1)<br/>Install ritual plugins in kernel repo + document operator setup path"]:::ms_draft
  E_18 --> M_071
  classDef epic_active fill:#d6eaff,stroke:#1a73e8,color:#000
  classDef epic_proposed fill:#f4f4f4,stroke:#888,color:#000
  classDef ms_done fill:#d8f5d8,stroke:#2a8a2a,color:#000
