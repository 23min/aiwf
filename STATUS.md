...
- → **M-066** — aiwf check finding entity-body-empty _(in_progress)_ — ACs 3/6 met (3 open) — tdd: required
...
flowchart LR
  ...
  M_066["M-066 (3/6)<br/>aiwf check finding entity-body-empty"]:::ms_in_progress
  E_17 --> M_066
...
| 2026-05-07 | human/peter | promote | aiwf promote M-066/AC-3 --phase red -> green |
