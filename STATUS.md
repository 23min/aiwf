...
- → **M-075** — Lifecycle-gate entity-body-empty rule (closes G-071) _(in_progress)_ — ACs 1/5 met (4 open) — tdd: required
...
flowchart LR
  ...
  M_075["M-075 (1/5)<br/>Lifecycle-gate entity-body-empty rule (closes G-071)"]:::ms_in_progress
  E_22 --> M_075
