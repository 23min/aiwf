...
- → **M-081** — Canonical 4-digit IDs in parser, renderer, and allocator _(in_progress)_ — ACs 5/6 met (1 open) — tdd: required
...
flowchart LR
  ...
  M_081["M-081 (5/6)<br/>Canonical 4-digit IDs in parser, renderer, and allocator"]:::ms_in_progress
  E_23 --> M_081
