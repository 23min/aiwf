...
- **M-0095** — Enforce human-only actor on aiwf promote E-NN active _(draft)_ — ACs 0/4 met (4 open) — tdd: required
...
flowchart LR
  ...
  E_0028 --> M_0094
  M_0095["M-0095 (0/4)<br/>Enforce human-only actor on aiwf promote E-NN active"]:::ms_draft
  E_0028 --> M_0095
