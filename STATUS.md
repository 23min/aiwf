...
_214 entities · 0 errors · 2 warnings · run `aiwf check` for details_
...
- → **M-0084** — Loader and id resolver span active and archive directories _(in_progress)_ — ACs 0/1 met (1 open) — tdd: required
...
flowchart LR
  ...
  M_0084["M-0084 (0/1)<br/>Loader and id resolver span active and archive directories"]:::ms_in_progress
  E_0024 --> M_0084
