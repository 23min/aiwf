...
- → **M-076** — Writer surface for milestone depends_on (closes G-072) _(in_progress)_ — ACs 0/7 met (7 open) — tdd: required
...
flowchart LR
  ...
  E_22 --> M_075
  M_076["M-076 (0/7)<br/>Writer surface for milestone depends_on (closes G-072)"]:::ms_in_progress
  E_22 --> M_076
