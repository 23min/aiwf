...
_189 entities · 0 errors · 9 warnings · run `aiwf check` for details_
...
- → **M-073** — aiwf-list skill, aiwf-status skill tightening _(in_progress)_ — ACs 2/5 met (3 open) — tdd: advisory
...
flowchart LR
  ...
  E_20 --> M_072
  M_073["M-073 (2/5)<br/>aiwf-list skill, aiwf-status skill tightening"]:::ms_in_progress
  E_20 --> M_073
