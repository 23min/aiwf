...
- → **M-0096** — Ship aiwfx-start-epic skill with worktree and branch preflight prompts _(in_progress)_ — ACs 2/5 met (3 open) — tdd: required
...
flowchart LR
  ...
  E_0028 --> M_0095
  M_0096["M-0096 (2/5)<br/>Ship aiwfx-start-epic skill with worktree and branch preflight prompts"]:::ms_in_progress
  E_0028 --> M_0096
...
| 2026-05-11 | human/peter | promote | aiwf promote M-0096/AC-2 --phase green -> done |
