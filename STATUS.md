...
- → **M-078** — Planning-conversation skills design ADR (placement, tiering, name rationale) _(in_progress)_ — ACs 4/5 met (1 open) — tdd: none
...
flowchart LR
  ...
  M_078["M-078 (4/5)<br/>Planning-conversation skills design ADR (placement, tiering, name rationale)"]:::ms_in_progress
  E_21 --> M_078
