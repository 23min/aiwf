...
- → **M-0094** — Add aiwf check finding epic-active-no-drafted-milestones _(in_progress)_ — ACs 2/4 met (2 open) — tdd: required
...
flowchart LR
  ...
  M_0094["M-0094 (2/4)<br/>Add aiwf check finding epic-active-no-drafted-milestones"]:::ms_in_progress
  E_0028 --> M_0094
