...
_197 entities · 0 errors · 6 warnings · run `aiwf check` for details_
...
|------|--------|------|---------|
| acs-tdd-audit | M-079/AC-5 | work/epics/E-21-open-work-synthesis-recommended-sequence-skill-replaces-critical-path-md/M-079-aiwfx-whiteboard-skill-classification-rubric-output-template-q-a-gate.md | M-079/AC-5 status: met under tdd: advisory but tdd_phase is red (expected done) |
...
| 2026-05-09 | human/peter | promote | aiwf promote M-079/AC-4 --phase  -> red |
| 2026-05-09 | human/peter | promote | aiwf promote M-079/AC-3 --phase green -> done |
| 2026-05-09 | human/peter | promote | aiwf promote M-079/AC-3 --phase red -> green |
