...
- → **M-0098** — Render-site layout overhaul: viewport-fill body, flush-left sidebar, prose cap _(in_progress)_ — ACs 2/5 met (3 open) — tdd: required
...
flowchart LR
  ...
  M_0098["M-0098 (2/5)<br/>Render-site layout overhaul: viewport-fill body, flush-left sidebar, prose cap"]:::ms_in_progress
  E_0029 --> M_0098
