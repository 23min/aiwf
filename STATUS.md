...
- → **M-072** — aiwf list verb, status filter-helper refactor, contract-skill drift fix _(in_progress)_ — ACs 1/9 met (8 open) — tdd: required
...
flowchart LR
  ...
  M_072["M-072 (1/9)<br/>aiwf list verb, status filter-helper refactor, contract-skill drift fix"]:::ms_in_progress
  E_20 --> M_072
