...
- → **M-081** — Canonical 4-digit IDs in parser, renderer, and allocator _(in_progress)_ — ACs 1/6 met (5 open) — tdd: required
...
flowchart LR
  ...
  M_081["M-081 (1/6)<br/>Canonical 4-digit IDs in parser, renderer, and allocator"]:::ms_in_progress
  E_23 --> M_081
...
|------|-------|------|--------|
| 2026-05-10 | human/peter | promote | aiwf promote M-081/AC-1 --phase green -> done |
