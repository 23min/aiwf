...
- **M-0099** — Kind-index chip filter: single emitted file per kind with :target chips _(draft)_ — ACs 0/4 met (4 open) — tdd: required
...
flowchart LR
  ...
  E_0029 --> M_0098
  M_0099["M-0099 (0/4)<br/>Kind-index chip filter: single emitted file per kind with :target chips"]:::ms_draft
  E_0029 --> M_0099
