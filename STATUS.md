...
- → **M-071** — Install ritual plugins in kernel repo + document operator setup path _(in_progress)_ — ACs 2/4 met (2 open) — tdd: required
...
flowchart LR
  ...
  E_18 --> M_070
  M_071["M-071 (2/4)<br/>Install ritual plugins in kernel repo + document operator setup path"]:::ms_in_progress
  E_18 --> M_071
...
| 2026-05-08 | human/peter | promote | aiwf promote M-071/AC-1 open -> met |
