...
- → **M-080** — Whiteboard skill fixture validation; retire critical-path.md; close E-21 _(in_progress)_ — ACs 3/7 met (4 open) — tdd: required
...
flowchart LR
  ...
  E_21 --> M_079
  M_080["M-080 (3/7)<br/>Whiteboard skill fixture validation; retire critical-path.md; close E-21"]:::ms_in_progress
  E_21 --> M_080
  classDef epic_active fill:#d6eaff,stroke:#1a73e8,color:#000
  classDef epic_proposed fill:#f4f4f4,stroke:#888,color:#000
  classDef ms_done fill:#d8f5d8,stroke:#2a8a2a,color:#000
...
|------|-------|------|--------|
| 2026-05-09 | human/peter | promote | aiwf promote M-080/AC-2 open -> met |
