...
_215 entities · 0 errors · 6 warnings · run `aiwf check` for details_
...
- → **M-0085** — aiwf archive verb (dry-run default, --apply, --kind) _(in_progress)_ — ACs 0/5 met (5 open) — tdd: required
...
flowchart LR
  ...
  E_0024 --> M_0084
  M_0085["M-0085 (0/5)<br/>aiwf archive verb (dry-run default, --apply, --kind)"]:::ms_in_progress
  E_0024 --> M_0085
