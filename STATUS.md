...
- → **M-0085** — aiwf archive verb (dry-run default, --apply, --kind) _(in_progress)_ — ACs 0/1 met (1 open) — tdd: required
...
flowchart LR
  ...
  E_0024 --> M_0084
  M_0085["M-0085 (0/1)<br/>aiwf archive verb (dry-run default, --apply, --kind)"]:::ms_in_progress
  E_0024 --> M_0085
