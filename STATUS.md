...
- → **M-072** — aiwf list verb, status filter-helper refactor, contract-skill drift fix _(in_progress)_ — ACs 2/9 met (7 open) — tdd: required
...
flowchart LR
  ...
  M_072["M-072 (2/9)<br/>aiwf list verb, status filter-helper refactor, contract-skill drift fix"]:::ms_in_progress
  E_20 --> M_072
