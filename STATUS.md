...
_189 entities · 0 errors · 10 warnings · run `aiwf check` for details_
...
- → **M-073** — aiwf-list skill, aiwf-status skill tightening _(in_progress)_ — ACs 3/5 met (2 open) — tdd: advisory
...
flowchart LR
  ...
  E_20 --> M_072
  M_073["M-073 (3/5)<br/>aiwf-list skill, aiwf-status skill tightening"]:::ms_in_progress
  E_20 --> M_073
...
| 2026-05-09 | human/peter | promote | aiwf promote M-073/AC-1 open -> met |
