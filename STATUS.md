...
- → **M-0086** — Three new archive check-rule findings and existing-rule scoping _(in_progress)_ — ACs 0/7 met (7 open) — tdd: required
...
flowchart LR
  ...
  E_0024 --> M_0085
  M_0086["M-0086 (0/7)<br/>Three new archive check-rule findings and existing-rule scoping"]:::ms_in_progress
  E_0024 --> M_0086
